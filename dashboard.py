...
with col1:
    ...
    ax.title('Rata-rata Jumlah Sewa Sepeda Berdasarkan Musim')
    ax.xlabel('Musim')
    ax.ylabel('Rata-rata Jumlah Sepeda')
    st.pyplot(fig)
...
with col2:
    ...
    ax.title('Rata-rata Jumlah Sewa Sepeda Berdasarkan Kondisi Cuaca')
    ax.xlabel('Kondisi Cuaca')
    ax.ylabel('Rata-rata Jumlah Sepeda')
    st.pyplot(fig)
